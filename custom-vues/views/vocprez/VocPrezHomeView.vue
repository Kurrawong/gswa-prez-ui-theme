...
<template>
  <FlavourHome flavour="VocPrez" :links="links">
    ...
    <p>
      ...
      (<a target="_blank" href="http://www.dmpe.wa.gov.au/gswa">GSWA</a>). The
    ...
    <h3>Contact</h3>
    <p>
      For more information or to provide feedback, contact <a href="mailto:GSWA.vocabularies@dmpe.wa.gov.au">GSWA.vocabularies@dmpe.wa.gov.au</a>
    </p>
